    ...
    <footer className="bg-black text-white pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12">
          ...
          >
            <h4 className="text-lg font-semibold text-white mb-5">Explore</h4>
            <ul className="space-y-3 text-sm">
              <li><a href="#hero" onClick={(e) => { e.preventDefault(); document.getElementById('hero').scrollIntoView({ behavior: 'smooth' }); }} className="text-white/80 hover:text-white transition-colors">Home</a></li>
              <li><a href="#problem" onClick={(e) => { e.preventDefault(); document.getElementById('problem').scrollIntoView({ behavior: 'smooth' }); }} className="text-white/80 hover:text-white transition-colors">The Problem</a></li>
              <li><a href="#solution" onClick={(e) => { e.preventDefault(); document.getElementById('solution').scrollIntoView({ behavior: 'smooth' }); }} className="text-white/80 hover:text-white transition-colors">Our Solution</a></li>
              <li><a href="#portfolio" onClick={(e) => { e.preventDefault(); document.getElementById('portfolio').scrollIntoView({ behavior: 'smooth' }); }} className="text-white/80 hover:text-white transition-colors">Our Work</a></li>
              <li><a href="#testimonials" onClick={(e) => { e.preventDefault(); document.getElementById('testimonials').scrollIntoView({ behavior: 'smooth' }); }} className="text-white/80 hover:text-white transition-colors">Testimonials</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-sm">
              <li><span className="text-white/80 cursor-default">Web Design & Development</span></li>
              <li><span className="text-white/80 cursor-default">3-Day Website Delivery</span></li>
              <li><span className="text-white/80 cursor-default">Mobile-First Design</span></li>
              <li><span className="text-white/80 cursor-default">Conversion Rate Optimization</span></li>
              <li><span className="text-white/80 cursor-default">SEO-Ready Websites</span></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-sm">
              <li>Email: <a href="mailto:hello@pixelrush.sites" className="text-white/80 hover:text-white transition-colors">hello@pixelrush.sites</a></li>
              <li>Phone: <a href="tel:+1-555-PIXRUSH" className="text-white/80 hover:text-white transition-colors">(555) PIX-RUSH</a></li>
              <li className="pt-2">
                <span className="block text-white/80">123 Web Design Ave,</span>
                <span className="block text-white/80">Suite 404, Internet City, CA 90210</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 mt-8 text-center text-sm">
          <p className="text-white/60">&copy; {currentYear} PixelRush Sites. All Rights Reserved. <a href="#" className="text-white/80 hover:text-white transition-colors">Privacy Policy</a> | <a href="#" className="text-white/80 hover:text-white transition-colors">Terms of Service</a></p>
        </div>
      </div>
    </footer>
  );
